...
secodndround <-   election_dat30 %>%
  ...
  mutate(value = str_remove_all(value, ", Germany")) %>% 
      ...
      columns = list(
        ...
        value = colDef(      
          ...
          cell = function(value) tagList(
            ...
            a(
              href = paste0("https://www.google.com/maps/search/?api=1&query=", URLencode(paste(value, "Germany"))),
        ...
        num_ads = colDef(
          ...
          cell = function(value, index) {
            ...
            # Build the hyperlink
            href <- if (theid != "unknown_page") {
              paste0("https://www.facebook.com/ads/library/?view_all_page_id=", theid)
            } else {
              "#"
            }
            # Return the link
...
htmltools::browsable(
  tagList(
    ...
    tags$button(
      tagList(fontawesome::fa("download"), "Download as CSV"),
      onclick = "Reactable.downloadDataCSV('elex2', 'targeting.csv')"
    )
  )
)
```
